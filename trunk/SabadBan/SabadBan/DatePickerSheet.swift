...
//  SabadBan
//
//  Created by Morteza Gharedaghi on 9/19/16.
...
class DatePickerSheet: UIView {
    ...
    init() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(DatePickerSheet.deviceOrientationDidChange(_:)), name: UIDeviceOrientationDidChangeNotification, object: nil)
    }
